...
Source0  : https://github.com/libproxy/libproxy/archive/0.5.6/libproxy-0.5.6.tar.gz
...
%prep
%setup -q -n libproxy-0.5.6
cd %{_builddir}/libproxy-0.5.6
pushd ..
cp -a libproxy-0.5.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714163419
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libproxy.so.0.5.6
/V3/usr/lib64/libproxy/libpxbackend-1.0.so
/usr/lib64/libproxy.so.0.5.6
