...
Version  : 0.5.4
Release  : 10
URL      : https://github.com/libproxy/libproxy/archive/0.5.4/libproxy-0.5.4.tar.gz
Source0  : https://github.com/libproxy/libproxy/archive/0.5.4/libproxy-0.5.4.tar.gz
...
%prep
%setup -q -n libproxy-0.5.4
cd %{_builddir}/libproxy-0.5.4
pushd ..
cp -a libproxy-0.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707777538
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libproxy.so.0.5.4
/V3/usr/lib64/libproxy/libpxbackend-1.0.so
/usr/lib64/libproxy.so.0.5.4
