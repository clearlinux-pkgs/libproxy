...
Source0  : https://github.com/libproxy/libproxy/archive/0.5.7/libproxy-0.5.7.tar.gz
...
%prep
%setup -q -n libproxy-0.5.7
cd %{_builddir}/libproxy-0.5.7
pushd ..
cp -a libproxy-0.5.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719263205
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libproxy.so.0.5.7
/V3/usr/lib64/libproxy/libpxbackend-1.0.so
/usr/lib64/libproxy.so.0.5.7
